...
int frameCallback(AVFrame *frame, int frameType, void *param) {
  printf("hello");
  return 0;
}
static int aa_read_thread(void *arg) {
  AVFormatContext *ic = (AVFormatContext * )arg;
  Sleep(100);
    return 0;
}
...
static int read_thread(void *arg)
{
    ...
    if (find_stream_info) {
        ...
        err = avformat_find_stream_info(ic, opts, frameCallback, NULL);
